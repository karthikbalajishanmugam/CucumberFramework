...
static WebDriver driver ;
	...
	public void method2() throws InterruptedException, IOException {
		...
		List<WebElement> TV = driver.findElements(By.xpath("//div[@class='_4rR01T']"));
		File f = new File("C:\\Users\\balas\\eclipse-workspace\\org.Test\\xl file\\tv list.xlsx");
	    FileOutputStream f1 = new FileOutputStream (f);
	    HSSFWorkbook w = new HSSFWorkbook();
	    HSSFSheet sheet = w.createSheet("all TV");
	    
	  
			
			for (int i=0; i< TV.size();i++) {
				
				  WebElement allTV = TV.get(i);
					 String allnames = allTV.getText();
...
String prwnd = driver.getWindowHandle();
		...
		File trg = new File("C:\\Users\\balas\\eclipse-workspace\\org.Test\\screenshote\\TV.png");
		FileUtils.copyFile(source,trg);
		
		
		HSSFSheet sheet2 = w.createSheet("selected TV");
	    ...
	    HSSFSheet Sheet2 = w1.getSheet("selected TV");
